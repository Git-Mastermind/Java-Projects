...
public class CardNetwork {
    ...
    public void processPayment(String customerCardNumber, int cvvNumber, String billingAddress, String expirationDate) {
        if (customerCardNumber.startsWith("4")) {
            ...
            visa.processPayment(customerCardNumber, cvvNumber, billingAddress, expirationDate);
        }
            ...
            americanExpress.processPayment(customerCardNumber, cvvNumber, billingAddress, expirationDate);
        }
        else if (customerCardNumber.substring(0, 5).equals("407372")) {
            IssuerBank wellsFargo = new IssuerBank("wells fargo");
            wellsFargo.processPayment(customerCardNumber, cvvNumber, billingAddress, expirationDate);
        }
            ...
            mastercard.processPayment(customerCardNumber, cvvNumber, billingAddress, expirationDate);
        }
        else if (customerCardNumber.substring(0, 5).equals("403075")) {
            IssuerBank chase = new IssuerBank("chase");
            chase.processPayment(customerCardNumber, cvvNumber, billingAddress, expirationDate);
        }
        else {
            IssuerBank happyBankOfDoughnutsAndPiggies = new IssuerBank("Happy Bank of Doughnuts and Piggies");
            happyBankOfDoughnutsAndPiggies.processPayment(customerCardNumber, cvvNumber, billingAddress, expirationDate);
        }
    }
}
